...
export function ActivityScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      notificationCenter?.setActivityTabActive(true);
      ...
      return () => {
        notificationCenter?.setActivityTabActive(false);
      };
    }, [notificationCenter, user?.id, load])
  );
  ...
  const onRefresh = useCallback(() => {
    ...
    void notificationCenter?.openActivityTab();
    void load();
  }, [user?.id, load, notificationCenter]);
